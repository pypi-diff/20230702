# Comparing `tmp/pylibsdm-1.0.0a0.dev0.tar.gz` & `tmp/pylibsdm-1.0.0a0.dev1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pylibsdm-1.0.0a0.dev0.tar", max compression
+gzip compressed data, was "pylibsdm-1.0.0a0.dev1.tar", max compression
```

## Comparing `pylibsdm-1.0.0a0.dev0.tar` & `pylibsdm-1.0.0a0.dev1.tar`

### file list

```diff
@@ -1,19 +1,19 @@
-drwxr-xr-x   0        0        0        0 2023-06-23 09:22:02.460136 pylibsdm-1.0.0a0.dev0/LICENSES/
--rw-r--r--   0        0        0    24842 2023-06-23 09:22:02.460136 pylibsdm-1.0.0a0.dev0/LICENSES/LGPL-2.0-or-later.txt
--rw-r--r--   0        0        0     3627 2023-06-27 19:42:08.823943 pylibsdm-1.0.0a0.dev0/README.md
--rw-r--r--   0        0        0      116 2023-06-27 15:04:34.683120 pylibsdm-1.0.0a0.dev0/pylibsdm/__init__.py
--rw-r--r--   0        0        0      116 2023-06-27 15:04:34.703120 pylibsdm-1.0.0a0.dev0/pylibsdm/backend/__init__.py
--rw-r--r--   0        0        0     8846 2023-07-02 16:37:39.056109 pylibsdm-1.0.0a0.dev0/pylibsdm/backend/validate.py
--rw-r--r--   0        0        0     1299 2023-06-27 20:26:53.087181 pylibsdm-1.0.0a0.dev0/pylibsdm/cli/__init__.py
--rw-r--r--   0        0        0     4429 2023-06-27 20:26:58.123129 pylibsdm-1.0.0a0.dev0/pylibsdm/cli/provision.py
--rw-r--r--   0        0        0     2122 2023-06-27 20:30:02.430861 pylibsdm-1.0.0a0.dev0/pylibsdm/cli/tap.py
--rw-r--r--   0        0        0      116 2023-06-27 17:30:02.589313 pylibsdm-1.0.0a0.dev0/pylibsdm/tag/__init__.py
--rw-r--r--   0        0        0      465 2023-06-27 20:20:27.310522 pylibsdm-1.0.0a0.dev0/pylibsdm/tag/ntag424dna/__init__.py
--rw-r--r--   0        0        0      973 2023-06-27 15:04:34.739120 pylibsdm-1.0.0a0.dev0/pylibsdm/tag/ntag424dna/const.py
--rw-r--r--   0        0        0    12704 2023-06-27 15:04:34.683120 pylibsdm-1.0.0a0.dev0/pylibsdm/tag/ntag424dna/structs.py
--rw-r--r--   0        0        0    12307 2023-06-27 19:42:34.123921 pylibsdm-1.0.0a0.dev0/pylibsdm/tag/ntag424dna/tag.py
--rw-r--r--   0        0        0     1414 2023-06-27 20:20:27.346524 pylibsdm-1.0.0a0.dev0/pylibsdm/tag/tag.py
--rw-r--r--   0        0        0      221 2023-06-27 15:04:34.731120 pylibsdm-1.0.0a0.dev0/pylibsdm/util.py
--rw-r--r--   0        0        0     1617 2023-07-02 16:35:52.300199 pylibsdm-1.0.0a0.dev0/pyproject.toml
--rw-r--r--   0        0        0     4891 1970-01-01 00:00:00.000000 pylibsdm-1.0.0a0.dev0/setup.py
--rw-r--r--   0        0        0     4794 1970-01-01 00:00:00.000000 pylibsdm-1.0.0a0.dev0/PKG-INFO
...
### Comparing `pylibsdm-1.0.0a0.dev0/LICENSES/LGPL-2.0-or-later.txt` & `pylibsdm-1.0.0a0.dev1/LICENSES/LGPL-2.0-or-later.txt`

 * *Files identical despite different names*

### Comparing `pylibsdm-1.0.0a0.dev0/README.md` & `pylibsdm-1.0.0a0.dev1/README.md`

 * *Files identical despite different names*

### Comparing `pylibsdm-1.0.0a0.dev0/pylibsdm/backend/validate.py` & `pylibsdm-1.0.0a0.dev1/pylibsdm/backend/validate.py`

 * *Files identical despite different names*

### Comparing `pylibsdm-1.0.0a0.dev0/pylibsdm/cli/__init__.py` & `pylibsdm-1.0.0a0.dev1/pylibsdm/cli/__init__.py`

 * *Files identical despite different names*

### Comparing `pylibsdm-1.0.0a0.dev0/pylibsdm/cli/provision.py` & `pylibsdm-1.0.0a0.dev1/pylibsdm/cli/provision.py`
...
### Comparing `pylibsdm-1.0.0a0.dev0/pylibsdm/cli/tap.py` & `pylibsdm-1.0.0a0.dev1/pylibsdm/cli/tap.py`

 * *Files identical despite different names*

### Comparing `pylibsdm-1.0.0a0.dev0/pylibsdm/tag/ntag424dna/const.py` & `pylibsdm-1.0.0a0.dev1/pylibsdm/tag/ntag424dna/const.py`

 * *Files identical despite different names*

### Comparing `pylibsdm-1.0.0a0.dev0/pylibsdm/tag/ntag424dna/tag.py` & `pylibsdm-1.0.0a0.dev1/pylibsdm/tag/ntag424dna/tag.py`

 * *Files identical despite different names*

### Comparing `pylibsdm-1.0.0a0.dev0/pylibsdm/tag/tag.py` & `pylibsdm-1.0.0a0.dev1/pylibsdm/tag/tag.py`

 * *Files identical despite different names*

### Comparing `pylibsdm-1.0.0a0.dev0/pyproject.toml` & `pylibsdm-1.0.0a0.dev1/pyproject.toml`
...
### Comparing `pylibsdm-1.0.0a0.dev0/setup.py` & `pylibsdm-1.0.0a0.dev1/setup.py`
...
### Comparing `pylibsdm-1.0.0a0.dev0/PKG-INFO` & `pylibsdm-1.0.0a0.dev1/PKG-INFO`
