# Comparing `tmp/oarepo-cli-11.1.4.tar.gz` & `tmp/oarepo-cli-11.1.5.tar.gz`
...
### Comparing `oarepo-cli-11.1.4/PKG-INFO` & `oarepo-cli-11.1.5/PKG-INFO`
...
### Comparing `oarepo-cli-11.1.4/README.md` & `oarepo-cli-11.1.5/README.md`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/build_command/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/build_command/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/build_command/wizard.py` & `oarepo-cli-11.1.5/oarepo_cli/build_command/wizard.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/config.py` & `oarepo-cli-11.1.5/oarepo_cli/config.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/develop/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/develop/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/develop/controller.py` & `oarepo-cli-11.1.5/oarepo_cli/develop/controller.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/develop/runners/docker.py` & `oarepo-cli-11.1.5/oarepo_cli/develop/runners/docker.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/develop/runners/local.py` & `oarepo-cli-11.1.5/oarepo_cli/develop/runners/local.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/develop/steps/check_db.py` & `oarepo-cli-11.1.5/oarepo_cli/develop/steps/check_db.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/develop/steps/check_s3_location.py` & `oarepo-cli-11.1.5/oarepo_cli/develop/steps/check_s3_location.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/develop/steps/check_search.py` & `oarepo-cli-11.1.5/oarepo_cli/develop/steps/check_search.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/develop/steps/check_site.py` & `oarepo-cli-11.1.5/oarepo_cli/develop/steps/check_site.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/develop/steps/check_venv.py` & `oarepo-cli-11.1.5/oarepo_cli/develop/steps/check_venv.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/develop/steps/develop_step.py` & `oarepo-cli-11.1.5/oarepo_cli/develop/steps/develop_step.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/develop/wizard.py` & `oarepo-cli-11.1.5/oarepo_cli/develop/wizard.py`
...
### Comparing `oarepo-cli-11.1.4/oarepo_cli/format/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/format/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/format/steps/base.py` & `oarepo-cli-11.1.5/oarepo_cli/format/steps/base.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/format/steps/format_javascript.py` & `oarepo-cli-11.1.5/oarepo_cli/format/steps/format_javascript.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/format/steps/format_jinja.py` & `oarepo-cli-11.1.5/oarepo_cli/format/steps/format_jinja.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/format/steps/format_python.py` & `oarepo-cli-11.1.5/oarepo_cli/format/steps/format_python.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/format/wizard.py` & `oarepo-cli-11.1.5/oarepo_cli/format/wizard.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/initialize/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/initialize/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/initialize/steps/create_monorepo.py` & `oarepo-cli-11.1.5/oarepo_cli/initialize/steps/create_monorepo.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/initialize/steps/initialize_directory.py` & `oarepo-cli-11.1.5/oarepo_cli/initialize/steps/initialize_directory.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/initialize/steps/install_nrp_cli.py` & `oarepo-cli-11.1.5/oarepo_cli/initialize/steps/install_nrp_cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/initialize/wizard.py` & `oarepo-cli-11.1.5/oarepo_cli/initialize/wizard.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/kill/__init__.py` & `oarepo-cli-11.1.5/oarepo_cli/kill/__init__.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/local/add/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/local/add/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/local/add/steps/add_local.py` & `oarepo-cli-11.1.5/oarepo_cli/local/add/steps/add_local.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/local/remove/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/local/remove/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/__init__.py` & `oarepo-cli-11.1.5/oarepo_cli/model/__init__.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/steps/add_custom_fields.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/steps/add_custom_fields.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/steps/add_docs_base.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/steps/add_docs_base.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/steps/add_files.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/steps/add_files.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/steps/add_metadata.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/steps/add_metadata.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/steps/add_nr_vocabularies.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/steps/add_nr_vocabularies.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/steps/add_permissions.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/steps/add_permissions.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/steps/add_pid_type.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/steps/add_pid_type.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/steps/add_relations.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/steps/add_relations.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/steps/add_tests.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/steps/add_tests.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/steps/add_vocabularies.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/steps/add_vocabularies.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/steps/create_model.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/steps/create_model.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/add/wizard.py` & `oarepo-cli-11.1.5/oarepo_cli/model/add/wizard.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/compile/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/model/compile/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/compile/steps/compile.py` & `oarepo-cli-11.1.5/oarepo_cli/model/compile/steps/compile.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/compile/steps/remove_previous.py` & `oarepo-cli-11.1.5/oarepo_cli/model/compile/steps/remove_previous.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/gen/base.py` & `oarepo-cli-11.1.5/oarepo_cli/model/gen/base.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/gen/formats.py` & `oarepo-cli-11.1.5/oarepo_cli/model/gen/formats.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/install/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/model/install/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/install/steps/alembic.py` & `oarepo-cli-11.1.5/oarepo_cli/model/install/steps/alembic.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/install/steps/test_model.py` & `oarepo-cli-11.1.5/oarepo_cli/model/install/steps/test_model.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/install/steps/update_index.py` & `oarepo-cli-11.1.5/oarepo_cli/model/install/steps/update_index.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/install/wizard.py` & `oarepo-cli-11.1.5/oarepo_cli/model/install/wizard.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/model_support.py` & `oarepo-cli-11.1.5/oarepo_cli/model/model_support.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/uninstall/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/model/uninstall/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/model/utils.py` & `oarepo-cli-11.1.5/oarepo_cli/model/utils.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/package_versions.py` & `oarepo-cli-11.1.5/oarepo_cli/package_versions.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/run/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/run/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/run/steps/run_server.py` & `oarepo-cli-11.1.5/oarepo_cli/run/steps/run_server.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/add/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/site/add/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/add/steps/check_requirements.py` & `oarepo-cli-11.1.5/oarepo_cli/site/add/steps/check_requirements.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/add/steps/compile_gui.py` & `oarepo-cli-11.1.5/oarepo_cli/site/add/steps/compile_gui.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/add/steps/init_database.py` & `oarepo-cli-11.1.5/oarepo_cli/site/add/steps/init_database.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/add/steps/init_files.py` & `oarepo-cli-11.1.5/oarepo_cli/site/add/steps/init_files.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/add/steps/install_invenio.py` & `oarepo-cli-11.1.5/oarepo_cli/site/add/steps/install_invenio.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/add/steps/install_site.py` & `oarepo-cli-11.1.5/oarepo_cli/site/add/steps/install_site.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/add/steps/link_env.py` & `oarepo-cli-11.1.5/oarepo_cli/site/add/steps/link_env.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/add/steps/next_steps.py` & `oarepo-cli-11.1.5/oarepo_cli/site/add/steps/next_steps.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/add/steps/start_containers.py` & `oarepo-cli-11.1.5/oarepo_cli/site/add/steps/start_containers.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/add/wizard.py` & `oarepo-cli-11.1.5/oarepo_cli/site/add/wizard.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/assets.py` & `oarepo-cli-11.1.5/oarepo_cli/site/assets.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/site/site_support.py` & `oarepo-cli-11.1.5/oarepo_cli/site/site_support.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/repo/{{cookiecutter.repo_name}}/.gitignore` & `oarepo-cli-11.1.5/oarepo_cli/templates/repo/{{cookiecutter.repo_name}}/.gitignore`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/repo/{{cookiecutter.repo_name}}/local/README.md` & `oarepo-cli-11.1.5/oarepo_cli/templates/repo/{{cookiecutter.repo_name}}/local/README.md`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/repo/{{cookiecutter.repo_name}}/models/README.md` & `oarepo-cli-11.1.5/oarepo_cli/templates/repo/{{cookiecutter.repo_name}}/models/README.md`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/repo/{{cookiecutter.repo_name}}/sites/README.md` & `oarepo-cli-11.1.5/oarepo_cli/templates/repo/{{cookiecutter.repo_name}}/sites/README.md`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/repo/{{cookiecutter.repo_name}}/ui/README.md` & `oarepo-cli-11.1.5/oarepo_cli/templates/repo/{{cookiecutter.repo_name}}/ui/README.md`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/LICENSE` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/LICENSE`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/cookiecutter.json` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/cookiecutter.json`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/diffs/oarepo-to-rdm-v11.0.patch` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/diffs/oarepo-to-rdm-v11.0.patch`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/hooks/post_gen_project.sh` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/hooks/post_gen_project.sh`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/.eslintrc.json` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/.eslintrc.json`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/.gitignore` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/.gitignore`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/README.md` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/README.md`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/app_data/vocabularies/affiliations_ror.yaml` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/app_data/vocabularies/affiliations_ror.yaml`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/app_data/vocabularies/subjects_oecd_fos.yaml` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/app_data/vocabularies/subjects_oecd_fos.yaml`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/assets/less/site/css.overrides` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/assets/less/site/css.overrides`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/assets/less/theme.config` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/assets/less/theme.config`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/assets/less/theme.less` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/assets/less/theme.less`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/build.sh` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/build.sh`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/docker/Dockerfile.production` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/docker/Dockerfile.production`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/docker/nginx/conf.d/default.conf` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/docker/nginx/conf.d/default.conf`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/docker/nginx/nginx.conf` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/docker/nginx/nginx.conf`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/docker-compose.full.yml` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/docker-compose.full.yml`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/docker-compose.yml` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/docker-compose.yml`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/docker-services.yml` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/docker-services.yml`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/invenio.cfg` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/invenio.cfg`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/site/setup.cfg` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/site/setup.cfg`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/site/{{cookiecutter.package_name}}/templates/semantic-ui/oarepo_ui/detail.html` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/site/{{cookiecutter.package_name}}/templates/semantic-ui/oarepo_ui/detail.html`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/site/{{cookiecutter.package_name}}/templates/semantic-ui/oarepo_ui/footer.html` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/site/{{cookiecutter.package_name}}/templates/semantic-ui/oarepo_ui/footer.html`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/site/{{cookiecutter.package_name}}/templates/semantic-ui/oarepo_ui/header.html` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/site/{{cookiecutter.package_name}}/templates/semantic-ui/oarepo_ui/header.html`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/site/{{cookiecutter.package_name}}/templates/semantic-ui/{{cookiecutter.package_name}}/searchbar.html` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/site/{{cookiecutter.package_name}}/templates/semantic-ui/{{cookiecutter.package_name}}/searchbar.html`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/site/{{cookiecutter.package_name}}/webpack.py` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/site/{{cookiecutter.package_name}}/webpack.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/static/images/invenio-rdm.svg` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/static/images/invenio-rdm.svg`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/static/images/logo-invenio-white.svg` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/static/images/logo-invenio-white.svg`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/variables` & `oarepo-cli-11.1.5/oarepo_cli/templates/site/{{cookiecutter.project_shortname}}/variables`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/cookiecutter.json` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/cookiecutter.json`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/.gitignore` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/.gitignore`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/LICENSE` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/LICENSE`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/MANIFEST.in` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/MANIFEST.in`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/setup.cfg` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/setup.cfg`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/ext.py` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/ext.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/resources/config.py` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/resources/config.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/templates/semantic-ui/{{cookiecutter.app_package}}/search.html` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/templates/semantic-ui/{{cookiecutter.app_package}}/search.html`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/js/{{cookiecutter.app_package}}/custom-components.js` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/js/{{cookiecutter.app_package}}/custom-components.js`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/js/{{cookiecutter.app_package}}/search/components/EmptyResultsElement.jsx` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/js/{{cookiecutter.app_package}}/search/components/EmptyResultsElement.jsx`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/js/{{cookiecutter.app_package}}/search/components/MultipleSearchBarElement.jsx` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/js/{{cookiecutter.app_package}}/search/components/MultipleSearchBarElement.jsx`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/js/{{cookiecutter.app_package}}/search/components/ResultsGridItem.jsx` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/js/{{cookiecutter.app_package}}/search/components/ResultsGridItem.jsx`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/js/{{cookiecutter.app_package}}/search/components/ResultsListItem.jsx` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/js/{{cookiecutter.app_package}}/search/components/ResultsListItem.jsx`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/js/{{cookiecutter.app_package}}/search/index.js` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/js/{{cookiecutter.app_package}}/search/index.js`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/less/{{cookiecutter.app_package}}/definitions/sample.less` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/less/{{cookiecutter.app_package}}/definitions/sample.less`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/i18next-scanner.config.js` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/i18next-scanner.config.js`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/i18next.js` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/i18next.js`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/messages/cs/messages.po` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/messages/cs/messages.po`
...
### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/messages/de/messages.po` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/messages/de/messages.po`
...
### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/messages/el/messages.po` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/messages/el/messages.po`
...
### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/messages/en/messages.po` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/messages/en/messages.po`
...
### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/package.json` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/package.json`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/scripts/compileCatalog.js` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/scripts/compileCatalog.js`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/scripts/initCatalog.js` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/scripts/initCatalog.js`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/yarn.lock` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/assets/semantic-ui/translations/{{cookiecutter.app_package}}/yarn.lock`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/webpack.py` & `oarepo-cli-11.1.5/oarepo_cli/templates/ui/{{cookiecutter.app_name}}/{{cookiecutter.app_package}}/theme/webpack.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/ui/add/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/ui/add/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/ui/add/mixins.py` & `oarepo-cli-11.1.5/oarepo_cli/ui/add/mixins.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/ui/add/steps/add_ui.py` & `oarepo-cli-11.1.5/oarepo_cli/ui/add/steps/add_ui.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/ui/add/steps/jinja.py` & `oarepo-cli-11.1.5/oarepo_cli/ui/add/steps/jinja.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/ui/add/wizard.py` & `oarepo-cli-11.1.5/oarepo_cli/ui/add/wizard.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/ui/install/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/ui/install/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/ui/install/wizard.py` & `oarepo-cli-11.1.5/oarepo_cli/ui/install/wizard.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/ui/uninstall/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/ui/uninstall/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/upgrade/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/upgrade/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/upgrade/steps/upgrade_nrp.py` & `oarepo-cli-11.1.5/oarepo_cli/upgrade/steps/upgrade_nrp.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/upgrade/steps/upgrade_site.py` & `oarepo-cli-11.1.5/oarepo_cli/upgrade/steps/upgrade_site.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/upgrade/wizard.py` & `oarepo-cli-11.1.5/oarepo_cli/upgrade/wizard.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/utils.py` & `oarepo-cli-11.1.5/oarepo_cli/utils.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/watch/cli.py` & `oarepo-cli-11.1.5/oarepo_cli/watch/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/watch/steps/watcher_step.py` & `oarepo-cli-11.1.5/oarepo_cli/watch/steps/watcher_step.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/wizard/base.py` & `oarepo-cli-11.1.5/oarepo_cli/wizard/base.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/wizard/docker.py` & `oarepo-cli-11.1.5/oarepo_cli/wizard/docker.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/wizard/steps.py` & `oarepo-cli-11.1.5/oarepo_cli/wizard/steps.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli/wizard/wizard.py` & `oarepo-cli-11.1.5/oarepo_cli/wizard/wizard.py`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/oarepo_cli.egg-info/PKG-INFO` & `oarepo-cli-11.1.5/oarepo_cli.egg-info/PKG-INFO`
...
### Comparing `oarepo-cli-11.1.4/oarepo_cli.egg-info/SOURCES.txt` & `oarepo-cli-11.1.5/oarepo_cli.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `oarepo-cli-11.1.4/setup.cfg` & `oarepo-cli-11.1.5/setup.cfg`
