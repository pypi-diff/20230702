# Comparing `tmp/aramgg-poro-0.0.4.tar.gz` & `tmp/aramgg-poro-0.0.5.tar.gz`
...
## Comparing `aramgg-poro-0.0.4.tar` & `aramgg-poro-0.0.5.tar`
...
### Comparing `aramgg-poro-0.0.4/setup.py` & `aramgg-poro-0.0.5/setup.py`
...
### Comparing `aramgg-poro-0.0.4/src/aramgg_poro.egg-info/SOURCES.txt` & `aramgg-poro-0.0.5/src/aramgg_poro.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/_configuration/pipeline.py` & `aramgg-poro-0.0.5/src/poro/_configuration/pipeline.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/apis/common.py` & `aramgg-poro-0.0.5/src/poro/apis/common.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/apis/ddragon/perk.py` & `aramgg-poro-0.0.5/src/poro/apis/ddragon/perk.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/apis/ddragon/sprite.py` & `aramgg-poro-0.0.5/src/poro/apis/ddragon/sprite.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/apis/riotapi/match.py` & `aramgg-poro-0.0.5/src/poro/apis/riotapi/match.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/apis/riotapi/summoner.py` & `aramgg-poro-0.0.5/src/poro/apis/riotapi/summoner.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/core/common.py` & `aramgg-poro-0.0.5/src/poro/core/common.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/core/ddragon/champion.py` & `aramgg-poro-0.0.5/src/poro/core/ddragon/champion.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/core/ddragon/item.py` & `aramgg-poro-0.0.5/src/poro/core/ddragon/item.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/core/ddragon/perk.py` & `aramgg-poro-0.0.5/src/poro/core/ddragon/perk.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/core/ddragon/profileicon.py` & `aramgg-poro-0.0.5/src/poro/core/ddragon/profileicon.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/core/ddragon/spell.py` & `aramgg-poro-0.0.5/src/poro/core/ddragon/spell.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/core/ddragon/sprite.py` & `aramgg-poro-0.0.5/src/poro/core/ddragon/sprite.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/core/riotapi/match.py` & `aramgg-poro-0.0.5/src/poro/core/riotapi/match.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/core/riotapi/summoner.py` & `aramgg-poro-0.0.5/src/poro/core/riotapi/summoner.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/data.py` & `aramgg-poro-0.0.5/src/poro/data.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/transformers/__init__.py` & `aramgg-poro-0.0.5/src/poro/transformers/__init__.py`

 * *Files identical despite different names*

### Comparing `aramgg-poro-0.0.4/src/poro/utils.py` & `aramgg-poro-0.0.5/src/poro/utils.py`
